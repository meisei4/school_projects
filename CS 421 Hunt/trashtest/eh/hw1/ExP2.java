...
public class ExP {
            ...
            //try{
                ...
                while(lin.hasNext()){
                    ...
                    if(token.equals("undefined")){
                        ...
                        scope = new Hashtable<String, String>();
                        String next = sc.next();
                        while(next != 
                    }
                }
    ...
    public static String interp(exp){
    Scanner lin = new Scanner(exp);
                LinkedList<String> expStack = new LinkedList<String>();   
                while(lin.hasNext()){
                    token = lin.next();
                    if(token.equals("undefined")){
    ...
    public static Hashtable<String, String> clone(Hashtable<String, String> surrogate){
        Hashtable<String, String> dolly = new Hashtable<String, String>();
        for(int i = 0; i < surrogate.size(); i++){
            dolly.put(identifiers.get(i), surrogate.get(identifiers.get(i)));
        }
        return dolly;
    }
